...
function menSort(){
  ...
  let sort1 =   Rompers.sort(function(a,b){
...
document.getElementById("Highlander").addEventListener("click", function(){
  // console.log("click")
  highlanderSort(Rompers)
})

function highlanderSort(Rompers){
  
  let sortedData = Rompers.filter(function(elem) {
...
function filterFun(){
     let appendarr=[]
  for(let i = 0; i<Rompers.length ;i++){

    if(Rompers[i].brand == "Roadster"){
       appendarr.push(Rompers[i])
