...
<div class="div1">
    <input  type="text" name="" id="search" placeholder="search for products, brands and more">
        ...
        <span><i class="fa-light fa-magnifying-glass">A &nbsp;</i></span> 
...
<div id="other_div">
    <div>
        <i class="fa-light fa-user-hair font"></i>
        <h5><a href="">Profile</a></h5>
    </div>

    <div>
        <i class="fa-light fa-heart font"></i>
      <h5><a href="">Whishlist</a></h5>  
    </div>

    <div>
        <i class="fa-light fa-bag-shopping font"></i>
        <h5>  <a href="">Bag</a></h5>
    </div>
</div>
